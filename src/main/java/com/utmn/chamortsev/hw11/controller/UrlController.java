package com.utmn.chamortsev.hw11.controller;

import com.utmn.chamortsev.hw11.dto.UrlUpdateRequest;
import com.utmn.chamortsev.hw11.entity.UrlEntity;
import com.utmn.chamortsev.hw11.entity.UrlResultEntity;
import com.utmn.chamortsev.hw11.repository.UrlRepository;
import com.utmn.chamortsev.hw11.repository.UrlResultRepository;
import com.utmn.chamortsev.hw11.service.UrlProcessingService;
...
@CrossOrigin(origins = "*")
@Tag(name = "URL Parser API", description = "API для сбора информации по контактов с сайтов")
public class UrlController {
    ...
    static class UrlRequest {
        @Schema(description = "URL (ссылка на страницу)", example = "https://example.com")
        private String url;
