package com.utmn.chamortsev.hw9.service;
...
import com.utmn.chamortsev.hw9.repository.UrlResultRepositorys;
...
public class UrlProcessingService {
    ...
    private final UrlResultRepositorys urlResultRepositorys;
    ...
    public UrlProcessingService(UrlRepository urlRepository, UrlResultRepositorys urlResultRepositorys) {
        this.urlRepository = urlRepository;
        this.urlResultRepositorys = urlResultRepositorys;
    ...
    public UrlResultEntity processSingleUrl(UrlEntity urlEntity) {
        ...
        try {
            ...
            UrlResultEntity savedResult = urlResultRepositorys.save(result);
    ...
    public Map<String, Object> getStatistics() {
        ...
        long totalResults = urlResultRepositorys.count();
        long successCount = urlResultRepositorys.countByStatusCode(200);
        Double avgResponseTime = urlResultRepositorys.findAverageResponseTime();
