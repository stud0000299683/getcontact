...
import com.utmn.chamortsev.hw9.dto.UrlUpdateRequest;
...
import com.utmn.chamortsev.hw9.service.UrlProcessingService;
...
public class UrlController {
    ...
    public UrlController(
            ...
            UrlResultRepositorys urlResultRepositorys,
    ...
    public List<UrlResultEntity> getAllResults() {
        return urlResultRepositorys.findActiveUrlResults();
    }
    ...
    public ResponseEntity<?> getUrlResults(
            ...
            @PathVariable Long urlId) {
        try {
            List<UrlResultEntity> results = urlResultRepositorys.findByUrlEntityIdOrderByProcessedAtDesc(urlId);
